...
const GroupEventDetailPage: React.FC = () => {
  ...
  const handleJoinToggle = () => {
    ...
    alert(
      isJoined ? "이벤트 참여가 취소되었습니다." : "이벤트에 참여했습니다!"
    );
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate("/courses/group")}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm">
            ...
            <p className="text-gray-600 text-sm mb-3">
              {eventDetail.meetingPoint}
            </p>
            {eventDetail.meetingPointLat &&
            eventDetail.meetingPointLng &&
            mapLoaded ? (
            ...
            <button
              ...
              onClick={() =>
                navigate(`/group-events/${eventId}/participants`, {
                  state: {
                    participants: eventDetail.participantsList,
