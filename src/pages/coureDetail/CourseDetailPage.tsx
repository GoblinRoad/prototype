        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white px-4 py-3 shadow-sm relative">
                <div className="flex items-center justify-between">
                    ...
                    <h1 className="text-lg font-semibold text-gray-900 flex-1 text-center pr-10">코스 상세정보</h1>
                    <div className="flex items-center space-x-2">
                        <button onClick={() => setIsLiked(!isLiked)} className="p-2 hover:bg-gray-100 rounded-lg">
            ...
            <div className="bg-white px-4 py-4 border-b">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="text-center">
            <span
                className={`inline-block px-3 py-1 text-sm font-medium rounded-full ${getDifficultyColor(courseDetail.difficulty)}`}
            >
                                ...
                                <div key={spot.id} className="bg-white rounded-xl overflow-hidden shadow-sm">
                                    ...
                                    <div className="p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <div className="flex items-center space-x-2">
                        <span
                            className={`px-2 py-1 text-xs font-medium rounded-full ${getCategoryColor(spot.category)}`}
                        >
                          {spot.category}
                        </span>
                            ...
                            <div className="text-center mb-4">
                                ...
                                <div className="flex items-center justify-center mt-1 mb-2">
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        <Star
                                            key={star}
                                            className={`w-5 h-5 ${star <= Math.floor(courseDetail.rating) ? "text-yellow-400 fill-current" : "text-gray-300"}`}
                                        />
                                    ))}
                                </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-white rounded-xl p-4 shadow-sm">
                                ...
                                <p className="text-sm text-gray-600">
                                    한강 경치가 정말 아름다워요! 평평한 길이라 걷기도 편하고, 일몰 시간에 플로깅하니 더욱 좋았습니다.
                                    쓰레기통도 곳곳에 있어서 편리해요.
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-4 shadow-sm">
                                ...
                                <p className="text-sm text-gray-600">
                                    가족과 함께 즐겁게 플로깅했습니다. 아이들도 쉽게 따라올 수 있는 코스예요. 다만 주말에는 사람이 많아서
                                    조금 복잡할 수 있어요.
                                </p>
                            </div>
                        </div>
