...
const MyPage: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 bg-gray-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-sm p-8 text-center">
            ...
            <p className="text-gray-600 mb-8">소셜 계정으로 간편하게 로그인하세요</p>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center justify-center w-full max-w-xs">
                  <img src="/images/kakaotalk_logo_icon.png" alt="카카오 로고" className="w-8 h-8 object-contain" />
              ...
              >
                <div className="flex items-center justify-center w-full max-w-xs">
                  <img src="/images/google_logo_icon.png" alt="구글 로고" className="w-8 h-8 object-contain" />
            ...
            <p className="text-xs text-gray-500 mt-6">
              로그인 시 개인정보 처리방침과 이용약관에 <br /> 동의하는 것으로 간주됩니다
            </p>
          </div>
        </div>
    )
  ...
  return (
      ...
      <div className="bg-gray-50 min-h-screen">
        ...
        <div className="px-4 mb-6">
          {userPreferences ? (
              <PreferencesSummary preferences={userPreferences} onEdit={handleEditPreferences} />
          ) : (
              <div className="bg-white rounded-xl p-4 shadow-sm">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">맞춤 추천 설정</h3>
                  <p className="text-gray-600 text-sm mb-4">선호도를 설정하면 더 정확한 코스 추천을 받을 수 있어요</p>
                  <button
            ...
            <div className="grid grid-cols-4 gap-4 sm:flex sm:gap-4 sm:overflow-x-auto sm:pb-2">
              ...
              {userProfile.badges.map((badge, index) => (
                  <div key={index} className="flex flex-col items-center min-w-[80px] flex-shrink-0">
                    ...
                    {/* 뱃지 이름 */}
                    <span className="text-sm font-medium text-gray-900 text-center leading-tight">{badge.name}</span>
                  </div>
              ))}
              ...
              <div className="flex flex-col items-center min-w-[80px] flex-shrink-0">
                ...
                {/* 버튼 텍스트 */}
                <span className="text-sm font-medium text-gray-600 text-center leading-tight">더 많은 뱃지</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* 활동 내역 모달 */}
        <ActivityHistoryModal isOpen={showActivityHistory} onClose={() => setShowActivityHistory(false)} />
        ...
        {/* 로그인 모달 */}
        <LoginModal isOpen={showLoginModal} onClose={() => setShowLoginModal(false)} onLogin={handleSocialLogin} />
        ...
        {/* 뱃지 상세 모달 */}
        <BadgeDetailModal isOpen={showBadgeDetail} onClose={() => setShowBadgeDetail(false)} />
