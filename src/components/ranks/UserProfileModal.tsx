            ...
            <div className="bg-white rounded-xl p-4 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <span className="font-bold text-gray-900">
                      {userDetail.monthlyStats.thisMonth.distance}km
                    </span>
                    <span className="text-xs text-red-500 ml-2">
                      -
                      {(
                        userDetail.monthlyStats.lastMonth.distance -
                        userDetail.monthlyStats.thisMonth.distance
                      ).toFixed(1)}
                      km
                    </span>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <span className="font-bold text-gray-900">
                      {userDetail.monthlyStats.thisMonth.cleanups}개
                    </span>
                    <span className="text-xs text-red-500 ml-2">
                      -
                      {userDetail.monthlyStats.lastMonth.cleanups -
                        userDetail.monthlyStats.thisMonth.cleanups}
                      개
                    </span>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <span className="font-bold text-gray-900">
                      {userDetail.monthlyStats.thisMonth.points}점
                    </span>
                    <span className="text-xs text-red-500 ml-2">
                      -
                      {userDetail.monthlyStats.lastMonth.points -
                        userDetail.monthlyStats.thisMonth.points}
                      점
                    </span>
                  </div>
                </div>
                  ...
                  <div key={index} className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">
                        {activity.date} • +{activity.points}점
                      </p>
                    </div>
                  </div>
                ))}
